...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 to-purple-100 relative w-full">
      <header className="bg-blue-800 text-white p-4 text-center font-bold text-lg sticky top-0 w-full z-10 shadow-md">
        MediQR
      </header>
